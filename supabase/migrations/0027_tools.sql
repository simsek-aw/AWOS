...
values
  ...
  ('awhr', 'AWhr', 'Recruiting & Urlaub (vertraulich)', '🧑‍💼', '#e879f9', 'internal', '/tools/awhr', 3, true),
  ('awmeet', 'AWmeet', 'Meetings transkribieren, zusammenfassen und To-Dos ableiten', '🎙️', '#579bfc', 'link', null, 4, false),
  ('awcreative', 'AWcreative', 'Produkte zu einer Bilderserie / Ads generieren', '🎨', '#fdab3d', 'link', null, 5, false),
  ('awtime', 'AWtime', 'Zeiterfassung', '⏱️', '#e2445c', 'link', null, 6, false)
